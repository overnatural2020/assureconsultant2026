                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4 items-stretch">
                    <div className="bg-[#eb6e54]/10 border border-[#eb6e54] rounded-2xl p-6 text-center flex flex-col justify-center">
                      ...
                      <div className="mt-4">
                        <span className="inline-flex items-center gap-1 bg-[#eb6e54] text-white text-sm font-bold px-4 py-1 rounded-full invisible" aria-hidden="true">
                          ☆ {t('common.special')}
                        </span>
                        <p className="text-xs text-[#00565f] italic mt-2">{t('memberships.family_regular_note')}</p>
                      </div>
                    </div>
